...
import { GetPointsByUser } from "../../application/useCases/GetPointsByUser";
...
export async function getUserInfo(
  ...
  const pointsBySubject = await GetPointsByUser(userId);
  const studySessions = await GetStudySessionsFromUser(userId);
